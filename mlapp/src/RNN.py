...
dataset = read_csv('/Users/rajatahuja/Documents/EE364D/Capstone-Project/mlapp/src/Combined_data_adjusted_full.csv', parse_dates = [['Year', 'Quarter']], index_col=0, date_parser=parse)
