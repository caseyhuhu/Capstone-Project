...
dataset = read_csv('amazon_data_formatted.csv', parse_dates = [['Year', 'Quarter']], index_col=0, date_parser = parse)
...
dataset.to_csv('testing_amazon.csv')

#Load dataset
dataset = read_csv('testing_amazon.csv',header=0, index_col=0)
